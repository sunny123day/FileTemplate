...
public class log4j extends AnAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        PsiFile psiFile = PsiFileFactory.getInstance(project).createFileFromText("log4j.properties", XMLLanguage.INSTANCE, renderedText);
