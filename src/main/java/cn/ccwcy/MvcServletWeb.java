...
public class MvcServletWeb extends AnAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        FileTemplate template = FileTemplateManager.getInstance(project)
                .getInternalTemplate("springmvc-servlet");
        String renderedText = "";
        ...
        PsiFile psiFile = PsiFileFactory.getInstance(project).createFileFromText("springmvc-servlet.xml", XMLLanguage.INSTANCE, renderedText);
