...
public class mybatis_config extends AnAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        FileTemplate template = FileTemplateManager.getInstance(project)
                .getInternalTemplate("mybatis-config");
        String renderedText = "";
        ...
        PsiFile psiFile = PsiFileFactory.getInstance(project).createFileFromText("mybatis-config.xml", XMLLanguage.INSTANCE, renderedText);
